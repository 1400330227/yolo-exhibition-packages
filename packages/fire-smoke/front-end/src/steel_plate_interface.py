...
class SteelPlateInterface(ScrollArea):
    ...
    def show_statistic(statistic_dic, label):
        try:
            ...
            results = ['当前画面' + str(i18n(i[0])) + '数量：' + str(i[1]) for i in statistic_dic]
    ...
    # key means the index of the combobox and value means the name of the combobox
